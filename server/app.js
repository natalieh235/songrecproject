...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email user-modify-playback-state user-top-read playlist-modify-private playlist-modify-public';
  ...
  if (state === null || state !== storedState) {
    ...
    request.post(authOptions, function(error, response, body) {
      if (!error && response.statusCode === 200) {
        ...
        res.redirect('https://better-song-rec.herokuapp.com/face/#' +
          querystring.stringify({
